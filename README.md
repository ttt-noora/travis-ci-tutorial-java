[![Build Status](https://app.travis-ci.com/ttt-noora/travis-ci-tutorial-java.svg?branch=master)](https://app.travis-ci.com/ttt-noora/travis-ci-tutorial-java)
[![Code Coverage](https://codecov.io/github/ttt-noora/travis-ci-tutorial-java/coverage.svg)](https://codecov.io/gh/ttt-noora/travis-ci-tutorial-java)
...
[Click here for the example using GitHub Actions instead of Travis CI](https://github.com/ttt-noora/github-ci-tutorial-java)

# How To Start

1. [Fork](https://github.com/ttt-noora/travis-ci-tutorial-java/fork) this Repository
...
- Add your repository (you can go there directly by going to https://codecov.io/gh/ttt-noora/travis-ci-tutorial-java)
...
[Open an Issue](https://github.com/ttt-noora/travis-ci-tutorial-java/issues/new)!
